...
- 🎨 **Vollständig anpassbar** via WordPress Customizer
  ...
  - 16 Google Fonts für Headlines + Body
...
- 💆 **Custom-Post-Type „Massage"** mit:
  - Beitragsbild
  - Kurztext (Auszug) + Langtext (Editor)
  - **Mehrere Preis-Optionen** pro Massage (z. B. 30/60/90 Min)
  - **Ermäßigt**-Preise mit optionalem Vorher-Preis („statt 75€ → 65€")
  - „Beliebt"-Badge
...
├── header.php                 # Header mit Suche + Menü
...
Nach der Theme-Aktivierung erscheint eine **Admin-Notice** mit einem Button „**Beispieldaten einfügen**". Klick darauf installiert:
